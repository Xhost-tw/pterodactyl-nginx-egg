...
echo "[Git] Cloning default repository 'https://github.com/Xhost-tw/pterodactyl-nginx-egg' into temporary directory."
git clone https://github.com/Xhost-tw/pterodactyl-nginx-egg /mnt/server/gtemp > /dev/null 2>&1 && echo "[Git] Repository cloned successfully." || { echo "[Git] Error: Default repository clone failed."; exit 21; }
